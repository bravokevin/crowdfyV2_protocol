...
describe("Crowfy Yielding", function () {
    ...
    const deployFabricContract = async () => {
        ...
        return { fabricContract, CREATION_TIME, WHITELISTED_TOKENS, owner, otherAccount, SWAP_ROUTER, QUOTER, WETH, ONE_ETH, TWO_ETH, contract, beneficiaryAccount }
    }
    ...
    describe("Yielding", function () {
        it("Should Allow to yield during early state", async function () {
            ...
            await contract.contribute(deadline, ONE_ETH, { from: owner, value: ONE_ETH })
